      ...
      <div className="bg-white rounded-2xl max-w-md w-full animate-fade-in" onClick={(e) => e.stopPropagation()}>
        ...
        <form onSubmit={handleEmailAuth} className="p-6 space-y-4">
          ...
          <button 
            type="submit"
            disabled={loading}
            className="w-full bg-blue-600 hover:bg-blue-700 disabled:bg-gray-400 text-white py-3 rounded-lg font-semibold transition-all"
          >
          ...
          <button 
            ...
            disabled={loading}
            className="w-full bg-white border-2 border-gray-300 hover:bg-gray-50 text-gray-700 py-3 rounded-lg font-semibold transition-all flex items-center justify-center gap-2"
          >
