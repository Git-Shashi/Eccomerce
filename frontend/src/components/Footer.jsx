      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-white text-xl font-bold">Ecom Store</h3>
            <p className="text-sm">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start">
                ...
                <span>123 Commerce Street, Suite 456<br/>San Francisco, CA 94102</span>
              </li>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex w-full md:w-auto">
              <input
                ...
                className="px-4 py-2 w-full md:w-64 bg-gray-800 text-white rounded-l-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"
              />
